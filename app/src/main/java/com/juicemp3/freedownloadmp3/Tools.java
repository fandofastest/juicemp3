package com.juicemp3.freedownloadmp3;
...
public class Tools {
    ...
    public static void displayImageRound(final Context ctx, final ImageView img, String urlimg) {
        try {
            Glide.with(ctx).load(urlimg).asBitmap().centerCrop().into(new BitmapImageViewTarget(img) {
                @Override
